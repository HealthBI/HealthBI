...
INSERT INTO dim_temporal VALUES (-2, 'Global', 'Global', 'Global', 'Global', 'Global', 'Global', 'Global', 'Global', 'Global', 'Global', 'Global');
INSERT INTO dim_temporal VALUES (2000, '2000', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA')
    ON CONFLICT (Temporal_UID) DO NOTHING;

create procedure insert_temporal(csv_temporal)
language plpgsql
as $$
declare
